...
Usage:
    python -m src.data_ops.validation.check_fwi_availability 20240901 20241231
    python -m src.data_ops.validation.check_fwi_availability 20250501 20251031 --config configs/default.yaml
"""
...
try:
    ...
    # Allow running from subdirectories like src/data_ops/validation.
