...
Usage:
  python -m src.data_ops.validation.check_alignment
  python -m src.data_ops.validation.check_alignment --config configs/paths_mac.yaml
  python -m src.data_ops.validation.check_alignment --fwi-dir /path/to/fwi --ecmwf-dir /path/to/ecmwf
"""
