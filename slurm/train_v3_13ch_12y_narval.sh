#!/bin/bash
#SBATCH --job-name=wf-v3-13ch-12y
#SBATCH --gpus-per-node=1
#SBATCH --time=1-00:00:00
#SBATCH --mem=480G
#SBATCH --output=/scratch/jiaqi217/logs/train_v3_13ch_12y_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_v3_13ch_12y_%j.err
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=jiaaqii.huang@mail.utoronto.ca
#SBATCH --account=def-inghaw

# ----------------------------------------------------------------
#   V3 13ch x enc{ENC} x 12y (2014-2022) TRAINING
# ----------------------------------------------------------------
...
#
# Usage:
#   ENC=14 sbatch slurm/train_v3_13ch_12y_narval.sh
#   ENC=21 sbatch slurm/train_v3_13ch_12y_narval.sh
#   ENC=28 sbatch slurm/train_v3_13ch_12y_narval.sh
#   ENC=35 sbatch slurm/train_v3_13ch_12y_narval.sh
#
# PREREQUISITES:
#   - 13ch cache at $SCRATCH/meteo_cache/v3_13ch_12y_2014
#     (built by 60178279)
# ----------------------------------------------------------------
...
CACHE_DIR_LUSTRE="$SCRATCH/meteo_cache/v3_13ch_12y_2014"
RUN_NAME="v3_13ch_enc${ENC}_12y_2014"
...
# 2026-05-02: copy 13ch 12y meteo to SSD (Lustre fancy-indexing slow)
LOCAL_METEO="$LOCAL_CACHE/meteo"
mkdir -p "$LOCAL_METEO"
echo "=== copy 13ch 12y meteo to local SSD (~470 GB) ==="
t0=$SECONDS
...
echo "============================================="
echo "  V3 13ch x enc${ENC} x 12y (2014-2022)"
