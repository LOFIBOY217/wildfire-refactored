#!/bin/bash
#SBATCH --job-name=wf-convlstm-baseline
#SBATCH --gpus-per-node=1
#SBATCH --time=0-12:00:00
#SBATCH --mem=400G
#SBATCH --output=/scratch/jiaqi217/logs/convlstm_baseline_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/convlstm_baseline_%j.err
#SBATCH --account=def-inghaw
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=jiaaqii.huang@mail.utoronto.ca

# ----------------------------------------------------------------
# CONVLSTM BASELINE — 12y × 9ch
# ----------------------------------------------------------------
# Answers: "is attention better than recurrent?" — 2-layer ConvLSTM2D
# over 21-day encoder history; 1×1 Conv head to 33 lead-day logits.
# Sacred geo-DL baseline (FireCastNet, ClimateBench, DeepCube all use).
#
# Range choice: 12y (matches current SOTA 12y enc21 = 7.83x) for direct
# attention-vs-recurrent comparison.
# Channel choice: 9ch (matches SOTA channel set).
# ----------------------------------------------------------------
...
RUN_NAME="baseline_convlstm_12y_2014_9ch"
...
echo "============================================="
echo "  CONVLSTM BASELINE — 12y × 9ch"
echo "  Run: $RUN_NAME"
echo "============================================="
...
$PYTHON -u -m src.training.train_v3 \
    ...
    --wandb_tags "baseline,convlstm,9ch,12y_2014" \
