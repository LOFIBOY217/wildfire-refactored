#!/bin/bash
#SBATCH --job-name=wf-v3-enc42
#SBATCH --gpus-per-node=1
#SBATCH --time=3-00:00:00
#SBATCH --mem=500G
#SBATCH --output=/scratch/jiaqi217/logs/train_v3_9ch_enc42_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_v3_9ch_enc42_%j.err
