#!/bin/bash
#SBATCH --job-name=wf-22y-climsim
#SBATCH --gpus-per-node=1
#SBATCH --time=1-00:00:00
#SBATCH --mem=750G
#SBATCH --output=/scratch/jiaqi217/logs/train_22y_climsim_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_22y_climsim_%j.err
#SBATCH --account=def-inghaw
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=jiaaqii.huang@mail.utoronto.ca

# ----------------------------------------------------------------
# 22y enc{ENC} 9ch + CLIMATE-SIMILARITY WEIGHTING (ENSO ONI)
# ----------------------------------------------------------------
# Replaces recency weighting with: weight = exp(-|year_oni - val_oni| / scale)
# Weights are pre-computed in
#   data/climate_indices/oni_similarity_22y_to_val2022_2025.csv
...
# Optional env:
#   CSV_NAME     filename (default oni_similarity_22y_to_val2022_2025.csv)
# ----------------------------------------------------------------

set -uo pipefail
ENC=${ENC:?Must set ENC (e.g. 21)}
CSV_NAME=${CSV_NAME:-oni_similarity_22y_to_val2022_2025.csv}
...
RUN_NAME="v3_9ch_enc${ENC}_2000_climsim"
...
echo "============================================="
echo "  V3 9ch enc${ENC} 22y CLIMATE-SIMILARITY"
echo "  Run: $RUN_NAME"
echo "  CSV: $CSV_PATH"
echo "  Weights:"
cat "$CSV_PATH"
...
$PYTHON -u -m src.training.train_v3 \
    ...
    --wandb_tags "9ch,enc${ENC},2000,22y,climate_sim_oni" \
