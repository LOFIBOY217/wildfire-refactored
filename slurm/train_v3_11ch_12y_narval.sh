#!/bin/bash
#SBATCH --job-name=wf-v3-11ch-12y
#SBATCH --gpus-per-node=1
#SBATCH --time=1-00:00:00
#SBATCH --mem=480G
#SBATCH --output=/scratch/jiaqi217/logs/train_v3_11ch_12y_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_v3_11ch_12y_%j.err
#SBATCH --account=def-inghaw
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=jiaaqii.huang@mail.utoronto.ca

# ----------------------------------------------------------------
# V3 11ch x enc{ENC} x 12y (2014-2022) — adds 2 free static channels
# ----------------------------------------------------------------
# Channel set: 9ch + elevation (DEM altitude) + aspect (slope direction)
...
#
# Usage:
#   ENC=21 sbatch slurm/train_v3_11ch_12y_narval.sh
# ----------------------------------------------------------------
...
CHANNELS="FWI,2t,fire_clim,2d,tcw,sm20,population,slope,burn_age,elevation,aspect"
CACHE_DIR_LUSTRE="$SCRATCH/meteo_cache/v3_11ch_12y_2014"
RUN_NAME="v3_11ch_enc${ENC}_12y_2014"
...
$PYTHON -u -m src.training.train_v3 \
    ...
    --wandb_tags "11ch,enc${ENC},12y_2014,12y,terrain_static" \
