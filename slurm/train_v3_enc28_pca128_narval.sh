#!/bin/bash
#SBATCH --job-name=wf-v3-pca
#SBATCH --gpus-per-node=1
#SBATCH --time=3-00:00:00
#SBATCH --mem=500G
#SBATCH --output=/scratch/jiaqi217/logs/train_v3_enc28_pcax4_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_v3_enc28_pcax4_%j.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=jiaaqii.huang@mail.utoronto.ca
#SBATCH --account=def-inghaw

# ----------------------------------------------------------------
# Best combo: enc28 + pca128 decoder (128 dim) + anti-overfit
#
# Why: enc28=6.43x is best encoder. s2s_legacy=9dim too compressed.
# pca128=128dim (14x more signal) and fits on SSD (309GB).
...
# Copy pca128 cache to SSD (309GB, fits on most nodes)
LOCAL_CACHE=$SLURM_TMPDIR/cache
mkdir -p "$LOCAL_CACHE"

S2S_SUB4_SCRATCH="$SCRATCH/meteo_cache/s2s_pca128_cache.dat"
S2S_SUB4_LOCAL="$LOCAL_CACHE/s2s_pca128_cache.dat"
...
if [ "$SSD_AVAIL_GB" -ge 400 ]; then
    echo "Copying pca128 cache (309G) to SSD..."
...
echo "============================================="
echo "  V3 enc28 + pca128 decoder (128 dim)"
echo "============================================="

$PYTHON -u -m src.training.train_v3 \
    --config configs/paths_narval.yaml \
    --run_name v3_enc28_pcax4 \
