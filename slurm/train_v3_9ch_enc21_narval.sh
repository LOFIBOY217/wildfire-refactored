#!/bin/bash
#SBATCH --job-name=wf-v3-enc21
#SBATCH --gpus-per-node=1
#SBATCH --time=3-00:00:00
#SBATCH --mem=500G
#SBATCH --output=/scratch/jiaqi217/logs/train_v3_9ch_enc21_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_v3_9ch_enc21_%j.err
...
echo "============================================="
echo "  V3 9ch — Encoder 21 days (bs=4096, drop=0.2)"
echo "============================================="
