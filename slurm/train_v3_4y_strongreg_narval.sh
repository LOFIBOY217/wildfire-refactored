#!/bin/bash
#SBATCH --job-name=wf-4y-reg
#SBATCH --gpus-per-node=1
#SBATCH --time=0-08:00:00
#SBATCH --mem=400G
#SBATCH --output=/scratch/jiaqi217/logs/train_4y_reg_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_4y_reg_%j.err
#SBATCH --account=def-inghaw
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=jiaaqii.huang@mail.utoronto.ca

# ----------------------------------------------------------------
# DIAGNOSTIC: 4y enc14 with STRONG REGULARIZATION
#
# Same hypothesis as 22y_strongreg: 4y enc14 also shows ep1-best
# overfit pattern (Lift 6.69 → 4.94 → 4.96 → 4.91). Test if stronger
# reg lets epochs 2-4 stay above ep1.
#
...
#   --epochs 4 (same)
#
# RUN_NAME: v3_9ch_enc${ENC}_4y_2018_strongreg
#
# Usage:
#   ENC=14 sbatch slurm/train_v3_4y_strongreg_narval.sh
# ----------------------------------------------------------------
...
TRAIN_CACHE_DIR="$SCRATCH/meteo_cache/v3_9ch_4y_2018"
RUN_NAME="v3_9ch_enc${ENC}_4y_2018_strongreg"

echo "============================================="
echo "  V3 9ch enc${ENC} 4y with STRONG REGULARIZATION"
echo "  Run: $RUN_NAME"
