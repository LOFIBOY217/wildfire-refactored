#!/bin/bash
#SBATCH --job-name=wf-rnd-1g
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=16
#SBATCH --gpus-per-node=1
#SBATCH --time=24:00:00
#SBATCH --output=/scratch/jiaqi217/logs/train_rnd_1g_%j.out
#SBATCH --error=/scratch/jiaqi217/logs/train_rnd_1g_%j.err
...
echo "=== STARTING TRAINING (random decoder, 1GPU, fire_season_only) ==="
