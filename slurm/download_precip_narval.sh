#!/bin/bash
#SBATCH --job-name=wf-dl-prec
#SBATCH --time=24:00:00
#SBATCH --mem=4G
#SBATCH --cpus-per-task=1
#SBATCH --output=/scratch/jiaqi217/logs/dl_prec_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/dl_prec_%j.err
...
python3 -u -m src.data_ops.download.download_era5_precip \
