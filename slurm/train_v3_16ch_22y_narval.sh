#!/bin/bash
#SBATCH --job-name=wf-v3-16ch-22y
#SBATCH --gpus-per-node=1
#SBATCH --time=1-00:00:00
#SBATCH --mem=750G
#SBATCH --output=/scratch/jiaqi217/logs/train_v3_16ch_22y_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_v3_16ch_22y_%j.err
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=jiaaqii.huang@mail.utoronto.ca
#SBATCH --account=def-inghaw

# ----------------------------------------------------------------
#   V3 16ch x enc{ENC} x 22y (2000-2021) TRAINING
# ----------------------------------------------------------------
...
#
# Usage:
#   ENC=14 sbatch slurm/train_v3_16ch_22y_narval.sh
#   ENC=21 sbatch slurm/train_v3_16ch_22y_narval.sh
#   ENC=28 sbatch slurm/train_v3_16ch_22y_narval.sh
#   ENC=35 sbatch slurm/train_v3_16ch_22y_narval.sh
#
# PREREQUISITES:
#   - 13ch cache at $SCRATCH/meteo_cache/v3_full_2000
#     (built by master 22y cache builder)
# ----------------------------------------------------------------
...
CACHE_DIR_LUSTRE="$SCRATCH/meteo_cache/v3_full_2000"
...
echo "============================================="
echo "  V3 16ch x enc${ENC} x 22y (2000-2021)"
...
$PYTHON -u -m src.training.train_v3 \
    ...
    --wandb_tags "13ch,enc${ENC},2000,22y" \
