...
# ----------------------------------------------------------------
# V3 9ch — anti-overfitting version
#
# Changes vs original v3-9s2s:
#   batch_size: 1024 → 4096 (4× fewer gradient updates per epoch)
#   dropout: 0.1 → 0.2 (stronger regularization)
#   epochs: 8 → 4 (best was always ep2-3, no point going further)
#
# Everything else identical: focal loss, hard neg mining, decoder_ctx
# ----------------------------------------------------------------
...
echo "============================================="
echo "  V3 9ch — Anti-Overfitting (bs=4096, drop=0.2, ep=4)"
