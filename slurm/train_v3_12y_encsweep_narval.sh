#!/bin/bash
#SBATCH --job-name=wf-12y-encsweep
#SBATCH --gpus-per-node=1
#SBATCH --time=0-12:00:00
#SBATCH --mem=400G
#SBATCH --output=/scratch/jiaqi217/logs/train_12y_encsweep_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_12y_encsweep_%j.err
#SBATCH --account=def-inghaw
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=jiaaqii.huang@mail.utoronto.ca

# ----------------------------------------------------------------
# 12y 9ch encoder-length sweep — fill the Fig 4c curve.
# Identical recipe to the SOTA training (v3_9ch_enc21_12y_2014); the
# ONLY varied knob is --in_days (=ENC). No spatial-neg, no gating.
# Existing points: enc14/21/28/35. This script adds enc7/10/42/56.
#
# Usage:
#   ENC=7  sbatch slurm/train_v3_12y_encsweep_narval.sh
#   ENC=10 sbatch slurm/train_v3_12y_encsweep_narval.sh
#   ENC=42 sbatch slurm/train_v3_12y_encsweep_narval.sh
#   ENC=56 sbatch slurm/train_v3_12y_encsweep_narval.sh
# Output: outputs/v3_9ch_enc${ENC}_12y_2014_per_window.json
#         checkpoints/v3_9ch_enc${ENC}_12y_2014/best_model.pt
# ----------------------------------------------------------------

set -uo pipefail
ENC=${ENC:?Must set ENC (e.g. 7, 10, 42, 56)}
...
echo "============================================="
echo "  V3 9ch enc${ENC} 12y  (encoder-length sweep)"
echo "  Run: $RUN_NAME"
echo "============================================="
...
$PYTHON -u -m src.training.train_v3 \
    ...
    --wandb_tags "9ch,enc${ENC},12y_2014,12y,encsweep" \
