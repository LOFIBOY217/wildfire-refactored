#!/bin/bash
#SBATCH --job-name=wf-v3-enc28
#SBATCH --gpus-per-node=1
#SBATCH --time=3-00:00:00
#SBATCH --mem=500G
#SBATCH --output=/scratch/jiaqi217/logs/train_v3_9ch_enc28_%j.log
#SBATCH --error=/scratch/jiaqi217/logs/train_v3_9ch_enc28_%j.err
...
echo "============================================="
echo "  V3 9ch — Encoder 28 days (bs=4096, drop=0.2)"
echo "============================================="
$PYTHON -u -m src.training.train_v3 \
    --config configs/paths_narval.yaml \
    --run_name v3_9ch_enc28 \
